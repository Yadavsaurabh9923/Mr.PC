<?php
    ...
    if(isset($_GET['id'])){
        ...
        if(pg_num_rows($result)==1)
        {
            ...
            header("Location: http://localhost/Website/Homepage/Products/Categories/Harddrives/Displaypage/productdisplaypage.php?Product_id=$pid");
            // echo "N Done";
            exit();
        }
        ...
        if(pg_num_rows($result1)>=1){
            header("Location: http://localhost/Website/Homepage/Products/Categories/Harddrives/Displaypage/productdisplaypage.php?Product_id=$pid&AlreadyAdded");
            // echo "N Done";
            exit();
            // echo $no;
        }
