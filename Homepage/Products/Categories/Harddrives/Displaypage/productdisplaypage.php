...
<?php
  ...
  $query="SELECT * FROM harddrives WHERE product_id=$productid;";
    ...
    while($row=pg_fetch_assoc($result))
        {
          ...
          $dsize =$row['drive_size'];
          $usbinterface =$row['usb_interface'];
          $trate =$row['transfer_rate'];
        ...
        <div class = "product-content">
          ...
          <div class = "product-detail">
            ...
            <ul>
              ...
              <li>Drive Size : <span><?php echo $dsize;?></span></li>
            </ul>
          </div>
...
$query="SELECT * FROM harddrives where brand='$product_brandname' and product_id!='$productid';";
  $result = pg_query($conn,$query);
    ...
    <!-- One Slide -->
      <div class="box">
        <div class="slide-img">
          ...
          <div class="overlay">
            <a href="http://localhost/Website/Homepage/Products/Categories/Harddrives/Displaypage/productdisplaypage.php?Product_id=<?php echo $datas[$x]['product_id']?>" class="buy-btn">Buy Now</a>
          </div>
