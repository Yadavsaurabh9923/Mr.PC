...
if(isset($_POST['action'])){
    $sql="SELECT * FROM harddrives WHERE stock_count>1";
  ...
  ";
    ...
    if (isset($_POST["formfactor"])) {
        ...
        $sql .= "
   AND drive_size IN('" . $graphics_filter . "')
  ";
    }
  ...
  ";
    ...
    if (isset($_POST["responsetime"])) {
        ...
        $sql .= "
   AND usb_interface IN('" . $responsetime . "')
  ";
    }
    ...
    if(pg_num_rows($result)>0)
    {
        while($row=pg_fetch_assoc($result))
        {
            ...
            <a class="button" href="http://localhost/Website/Homepage/Products/Categories/Harddrives/Displaypage/productdisplaypage.php?Product_id='.$row["product_id"].'">Buy Now</a>
            </figure>';
        }
    }
