...
<?php
  ...
  $query="SELECT * FROM ram WHERE product_id=$productid;";
        ...
        <div class = "product-content">
          ...
          <div class = "product-detail">
            ...
            <ul>
              ...
              <li>Size : <span><?php echo $rsize,' GB';?></span></li>
            </ul>
          </div>
  ...
  <div class="column">
    ...
    <tr>
      ...
      <tr>
        ...
        <td><?php echo $mtech ?></td>
      </tr>
      <tr>
        <td>Voltage</td>
        <td><?php echo $voltage,' Volts' ?></td>
      </tr>
...
$query="SELECT * FROM ram where brand='$product_brandname' and product_id!='$productid';";
  $result = pg_query($conn,$query);
    ...
    <!-- One Slide -->
      <div class="box">
        <div class="slide-img">
          ...
          <div class="overlay">
            <a href="http://localhost/Website/Homepage/Products/Categories/Ram/Displaypage/productdisplaypage.php?Product_id=<?php echo $datas[$x]['product_id']?>" class="buy-btn">Buy Now</a>
          </div>
