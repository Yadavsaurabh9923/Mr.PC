...
<?php
  ...
  $query="SELECT * FROM os WHERE product_id=$productid;";
        ...
        <div class = "product-content">
          ...
          <div class = "product-detail">
            ...
            <ul>
              ...
              <li>Category :  <span><?php echo 'Operating System'?></span></li>
    ...
    <!-- One Slide -->
      <div class="box">
        <div class="slide-img">
          ...
          <div class="overlay">
            <a href="http://localhost/Website/Homepage/Products/Categories/os/Displaypage/productdisplaypage.php?Product_id=<?php echo $datas[$x]['product_id']?>" class="buy-btn">Buy Now</a>
          </div>
