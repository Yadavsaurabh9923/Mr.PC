...
if(isset($_POST['action'])){
    $sql="SELECT * FROM laptops WHERE stock_count>1";
  ...
  ";
    ...
    if (isset($_POST["graphics"])) {
        ...
        $sql .= "
   AND graphics_type IN('" . $graphics_filter . "')
  ";
    }
  ...
  ";
    ...
    if(pg_num_rows($result)>0)
    {
        while($row=pg_fetch_assoc($result))
        {
            ...
            <a class="button" href="http://localhost/Website/Homepage/Products/Categories/Laptops/Displaypage/productdisplaypage.php?Product_id='.$row["product_id"].'">Buy Now</a>
            </figure>';
        }
    }
