...
<?php
  ...
  $query="SELECT * FROM Laptops WHERE product_id=$productid;";
    ...
    while($row=pg_fetch_assoc($result))
        {
          ...
          $product_os = $row['operating_system'];
          $product_modelname = $row['model_name'];

          $cpu_details =$row['cpu_details'];
          $maxcpuspeed =$row['maxcpuspeed'];
          $os =$row['operating_system'];
          $ram =$row['ram'];
          $hdd_size =$row['hdd_size'];
          $ssd_size =$row['ssd_size'];
          $weight =$row['weight'];
          $screendetails =$row['screen_size'];
          $screenfreq =$row['screen_frequency'];
          $graphicssize =$row['graphics_size'];
          $graphicsname =$row['graphics_name'];
          $graphicstype =$row['graphics_type'];
          $batteries =$row['batteries'];
          $connectivity_type =$row['connectivity_type'];
          $usbports =$row['no_of_usb_ports'];
          $otherports =$row['other_ports'];
        ...
        <div class = "product-content">
          ...
          <div class = "product-detail">
            ...
            <ul>
              ...
              <li>Operating System: <span><?php echo $product_os;?></span></li>
...
<div class="row">
  <div class="column">
    <table>
      ...
      <tr>
        <td>CPU Details</td>
        <td><?php echo $cpu_details ?></td>
      </tr>
      <tr>
        <td>Max CPU Speed</td>
        <td><?php echo $maxcpuspeed ?></td>
      </tr>
      <tr>
        <td>OS</td>
        <td><?php echo $os ?></td>
      ...
      <tr>
        <td>HDD Size</td>
        <td><?php echo $hdd_size ?></td>
      </tr>
      <tr>
        <td>SSD Size</td>
        <td><?php echo $ssd_size ?></td>
      </tr>
      <tr>
      <tr>
        <td>Warranty</td>
  ...
  <div class="column">
    <table>
      ...
      <tr>
        ...
        <td><?php echo $screendetails ?></td>
      </tr>
      <tr>
        <td>Screen Frequency</td>
        <td><?php echo $screenfreq ?></td>
      </tr>
      <tr>
        <td>Graphics Size</td>
        <td><?php echo $graphicssize ?></td>
      </tr>
      <tr>
        <td>Graphics Name</td>
        <td><?php echo $graphicsname ?></td>
      </tr>
      <tr>
        <td>Graphics Type</td>
        <td><?php echo $graphicstype ?></td>
      </tr>
      <tr>
        <td>Batteries</td>
        <td><?php echo $batteries ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><?php echo $usbports ?></td>
      </tr>
      <tr>
        <td>Total Other Ports</td>
        <td><?php echo $otherports ?></td>
      </tr>
      <tr>
        <td>Battery Life</td>
...
$query="SELECT * FROM laptops where subcategory='$product_usage' and brand='$product_brandname' and product_id!='$productid';";
  $result = pg_query($conn,$query);
    ...
    <!-- One Slide -->
      <div class="box">
        <div class="slide-img">
          ...
          <div class="overlay">
            <a href="http://localhost/Website/Homepage/Products/Categories/Laptops/Displaypage/productdisplaypage.php?Product_id=<?php echo $datas[$x]['product_id']?>" class="buy-btn">Buy Now</a>
          </div>
