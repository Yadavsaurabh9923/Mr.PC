<?php
    ...
    if(pg_num_rows($result)==1){
        ...
        $query="SELECT * FROM wishlist WHERE wuserid='$userid' AND wpid=$id;";
        $result=pg_query($conn,$query);
        ...
        if(pg_num_rows($result)==0){
            ...
            header("Location:http://localhost/Website/Homepage/Products/Categories/Motherboards/Displaypage/productdisplaypage.php?Product_id=$id&error=AlreadyAdded");
        }
    }
