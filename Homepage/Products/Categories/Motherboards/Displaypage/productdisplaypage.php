...
<?php
  ...
  $query="SELECT * FROM motherboards WHERE product_id=$productid;";
    ...
    while($row=pg_fetch_assoc($result))
        {
          ...
          $ram_tech=$row['ram_technology'];
          $graphics_tech=$row['graphics_technology'];
        ...
        <div class = "product-content">
          ...
          <div class = "product-detail">
            ...
            <ul>
              ...
              <li>Ram Technology : <span><?php echo $ram_tech;?></span></li>
              <li>Graphics Technology: <span><?php echo $graphics_tech;?></span></li>
  ...
  <div class="column">
    <table>
      ...
      <tr>
        ...
        <td><?php echo $ram_tech ?></td>
      </tr>
      <tr>
        <td>Graphics Technology</td>
        <td><?php echo $graphics_tech ?></td>
      </tr>
      <tr>
        <td>Warranty</td>
...
$query="SELECT * FROM motherboards where brand='$product_brandname' and product_id!='$productid';";
  $result = pg_query($conn,$query);
    ...
    <!-- One Slide -->
      <div class="box">
        <div class="slide-img">
          ...
          <div class="overlay">
            <a href="http://localhost/Website/Homepage/Products/Categories/Motherboards/Displaypage/productdisplaypage.php?Product_id=<?php echo $datas[$x]['product_id']?>" class="buy-btn">Buy Now</a>
          </div>
