...
<?php
  ...
  $query="SELECT * FROM cabinets WHERE product_id=$productid;";
    ...
    while($row=pg_fetch_assoc($result))
        {
          ...
          $product_formfactor =$row['form_factor'];
          $motherboardsupport  =$row['motherboard_support'];
      ...
      <div class = "card">
        ...
        <div class = "product-content">
          ...
          <div class = "product-detail">
            ...
            <ul>
              <li>Material : <span><?php echo $product_material;?></span></li>
  ...
  <div class="column">
    <table>
      ...
      <tr>
        ...
        <td><?php echo $motherboardsupport ?></td>
      </tr>
...
$query="SELECT * FROM cabinets where subcategory='$product_usage' and product_id!='$productid';";
  $result = pg_query($conn,$query);
    ...
    <!-- One Slide -->
      <div class="box">
        <div class="slide-img">
          ...
          <div class="overlay">
            <a href="http://localhost/Website/Homepage/Products/Categories/Cabinets/Displaypage/productdisplaypage.php?Product_id=<?php echo $datas[$x]['product_id']?>" class="buy-btn">Buy Now</a>
          </div>
