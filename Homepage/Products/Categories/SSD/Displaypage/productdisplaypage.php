...
<?php
  ...
  $query="SELECT * FROM ssd WHERE product_id=$productid;";
...
$query="SELECT * FROM ssd where brand='$product_brandname' and product_id!='$productid';";
  $result = pg_query($conn,$query);
    ...
    <!-- One Slide -->
      <div class="box">
        <div class="slide-img">
          ...
          <div class="overlay">
            <a href="http://localhost/Website/Homepage/Products/Categories/SSD/Displaypage/productdisplaypage.php?Product_id=<?php echo $datas[$x]['product_id']?>" class="buy-btn">Buy Now</a>
          </div>
