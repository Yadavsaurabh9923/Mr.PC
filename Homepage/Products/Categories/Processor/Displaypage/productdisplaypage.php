...
<?php
  ...
  $query="SELECT * FROM processor WHERE product_id=$productid;";
    ...
    while($row=pg_fetch_assoc($result))
        {
          ...
          $threads =$row['total_threads'];
          $processorspeed  =$row['processor_speed'];
        ...
        <div class = "product-content">
          ...
          <div class = "product-detail">
            ...
            <ul>
              ...
              <li>Wattage : <span><?php echo $wattage;?></span></li>
            </ul>
          </div>
...
$query="SELECT * FROM processor where brand='$product_brandname' and product_id!='$productid';";
  $result = pg_query($conn,$query);
    ...
    <!-- One Slide -->
      <div class="box">
        <div class="slide-img">
          ...
          <div class="overlay">
            <a href="http://localhost/Website/Homepage/Products/Categories/Processor/Displaypage/productdisplaypage.php?Product_id=<?php echo $datas[$x]['product_id']?>" class="buy-btn">Buy Now</a>
          </div>
