...
<?php
  ...
  $query="SELECT * FROM graphics WHERE product_id=$productid;";
    ...
    while($row=pg_fetch_assoc($result))
        {
          ...
          $gsize =$row['graphics_size'];
          $gtype =$row['graphics_ramtype'];
          $wattage =$row['wattage'];
        ...
        <div class = "product-content">
          ...
          <div class = "product-detail">
            ...
            <ul>
              ...
              <li>Graphics Size : <span><?php echo $gsize,' GB';?></span></li>
            </ul>
          </div>
...
$query="SELECT * FROM graphics where graphics_size='$gsize' and product_id!='$productid';";
  $result = pg_query($conn,$query);
    ...
    <!-- One Slide -->
      <div class="box">
        <div class="slide-img">
          ...
          <div class="overlay">
            <a href="http://localhost/Website/Homepage/Products/Categories/Graphics/Displaypage/productdisplaypage.php?Product_id=<?php echo $datas[$x]['product_id']?>" class="buy-btn">Buy Now</a>
          </div>
