...
<?php
  ...
  $query="SELECT * FROM monitors WHERE product_id=$productid;";
    ...
    while($row=pg_fetch_assoc($result))
        {
          ...
          $viewingangle =$row['viewing_angle'];
          $refreshrate =$row['refresh_rate'];
          $displaytech  =$row['display_technology'];
        ...
        <div class = "product-content">
          ...
          <div class = "product-detail">
            ...
            <ul>
              ...
              <li>Response Time : <span><?php echo $responsetime;?></span></li>
            </ul>
          </div>
...
<div class="row">
  ...
  <div class="column">
    <table>
      ...
      <tr>
        <td>Response Time</td>
        <td><?php echo $responsetime ?></td>
      </tr>
      <tr>
        <td>Display Technology</td>
        <td><?php echo $displaytech ?></td>
      </tr>
...
$query="SELECT * FROM monitors where subcategory='$product_usage' and product_id!='$productid';";
  $result = pg_query($conn,$query);
    ...
    <!-- One Slide -->
      <div class="box">
        <div class="slide-img">
          ...
          <div class="overlay">
            <a href="http://localhost/Website/Homepage/Products/Categories/Monitors/Displaypage/productdisplaypage.php?Product_id=<?php echo $datas[$x]['product_id']?>" class="buy-btn">Buy Now</a>
          </div>
